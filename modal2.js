...
// Fonction bouton ajouter nouveau projet

function btnNewProject() {

    document.querySelector(".modal-box-btn").innerHTML = `
        ...
        <br>
        <button class="del-projects" id="del-projects">Supprimer la galerie</button>
    `;
...
// Fonction bouton ajouter nouveau projet
function btnNewProjectRemove() {

    var reactListDiv = document.querySelector('.modal-box');
...
function genererProjectModal(projectModal) {
    ...
    document.querySelector(".modal-project-gallery").innerHTML = `

    <h2>Galerie photo</h2>

    <div class="modal-box-list"> </div>
    <div class="modal-box-btn"> </div>
`;
...
// Fonction reload project


function reloadProject(){


    var reactListDiv = document.querySelector('.modal-box-list');

        reactListDiv.remove();


    console.log("On supprime les projets")

  }



function reloadProject2(){
